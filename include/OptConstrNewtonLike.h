...
// These are used by all derived classes
  ...
  void fPrintSecSuff(std::ostream *nlpout, NEWMAT::ColumnVector& info);

  friend int trustregion(NLP1*, std::ostream*, NEWMAT::SymmetricMatrix&,
			 NEWMAT::ColumnVector&, NEWMAT::ColumnVector&,
			 real&, real&, real stpmax, real stpmin);

  friend int trustpds(NLP1*, std::ostream*, NEWMAT::SymmetricMatrix&,
		      NEWMAT::ColumnVector&, NEWMAT::ColumnVector&,
