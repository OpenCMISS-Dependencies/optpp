...
int trustregion(NLP1*, std::ostream*, NEWMAT::SymmetricMatrix&, 
		NEWMAT::ColumnVector&, 
		NEWMAT::ColumnVector&, real&, real&, real stpmax = 1.e3,
		real stpmin = 1.e-9);

int trustpds(NLP1*, std::ostream*, NEWMAT::SymmetricMatrix&, 
	     NEWMAT::ColumnVector&, 
	     NEWMAT::ColumnVector&, real&, real&, real stpmax = 1.e3,
	     real stpmin = 1.e-9, int searchSize = 64);

int dogleg(NLP1*, std::ostream*, NEWMAT::SymmetricMatrix&, 
	   NEWMAT::ColumnVector&, NEWMAT::ColumnVector&,
           NEWMAT::ColumnVector&, real&, real&, real);

int pdsstep(NLP1*, std::ostream*, NEWMAT::SymmetricMatrix&, 
	    NEWMAT::ColumnVector&, NEWMAT::ColumnVector&, 
	    NEWMAT::ColumnVector&, real&, real&, real, double&, bool, int);

int linesearch(NLP1*, std::ostream*, NEWMAT::ColumnVector&, 
	       NEWMAT::ColumnVector&, real *,
	       real stpmax = 1.e3, real stpmin = 1.e-9,
 	       int itnmax = 5, real ftol = 1.e-4, real xtol = 2.2e-16, 
	       real gtol = 0.9);

int backtrack(NLP1*, std::ostream*, NEWMAT::ColumnVector&, NEWMAT::ColumnVector&, real *,
	      int itnmax = 5, real ftol = 1.e-4, 
              real stpmax = 1.e3, real stpmin = 1.e-9);

int mcsrch(NLP1*, NEWMAT::ColumnVector&, std::ostream*, real *,
	   int itnmax = 5, real ftol = 1.e-4, real xtol = 2.2e-16, 
