...
/// Print state of NLP2 object to file
  virtual void fPrintState(std::ostream *nlpout, char* s ) ;
...
void FPrint(std::ostream *fout, const NEWMAT::Matrix& X);
void FPrint(std::ostream *fout, const NEWMAT::SymmetricMatrix& X);
void FPrint(std::ostream *fout, const NEWMAT::DiagonalMatrix& X);
